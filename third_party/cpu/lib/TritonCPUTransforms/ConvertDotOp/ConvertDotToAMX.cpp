...
Value loadTile(Location loc, VectorType tileTy, const MemBuffer &buf,
...
void storeTile(Location loc, VectorType tileTy, Value val,
...
loadBlockTiles(Location loc, VectorType tileTy, const MemBuffer &buf,
               int64_t tilesInBlockM, int64_t tilesInBlockN, int64_t blockM,
...
void storeBlockTiles(Location loc, VectorType tileTy, const MemBuffer &buf,
